<template>
    <div id="add-item">
        <h2>Edit Details of Location </h2>
       <b-form v-if="!submitted">
            ...
            <b-col> <b-button v-on:click.prevent="patch" id="add-button"> Submit New Location </b-button> </b-col>
        </b-form>
  ...
  methods: {
    patch: function () {
      Api.patch('/locations/' + this.id, {
        ...
        this.newLocation = []
        this.errorMessage = true
        this.detailedErrorMessage = 'Failed to patch location'
      })
    }
  }
}
